...
-- For FreeDB.tech (database already exists)
...
CREATE INDEX IF NOT EXISTS idx_face_training_employee ON face_training(employee_id);

-- Insert sample admin account (password: admin123)
INSERT IGNORE INTO admins (name, email, phone, organization, username, password, security_question, security_answer) VALUES
...
INSERT IGNORE INTO employees (admin_id, name, email, phone, qr_code) VALUES
...
INSERT IGNORE INTO attendance (employee_id, status, timestamp) VALUES
